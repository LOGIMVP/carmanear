...
<head>
    ...
    <style>
        body { background-color: #000000; color: #ffffff; font-family: 'Inter', sans-serif; display: flex; justify-content: center; align-items: center; min-height: 100vh; margin: 0; }
        .carmanear-font { font-family: 'Syne', sans-serif; }
    </style>
</head>
<body>

    <div class="flex flex-col items-center text-center w-full max-w-md px-6">
